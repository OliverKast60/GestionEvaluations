...
if (strlen($_SESSION['sid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "UPDATE `tblfaculties` SET `f_name`='$nom_faculte' WHERE id = '" . $_GET['edit'] . "'");
...
?>
    ...
    <body id="body-pd">
        ...
        <div class="height-100" style="margin-left:20px;margin-top: 90px;">
            <h4 class="text-primary"><i class="fas fa-edit"></i> Modifier faculté </h4>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                                                    ...
                                                    <div class=" mt-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                $id = $_GET['edit'];
                                                                $fac = $dbj->query("SELECT * FROM tblfaculties WHERE id = $id");
                                                                ...
                                                                <form method="post">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="text" class="form-control mb-3" placeholder="Nom de la faculté" name="faculte" value="<?php echo $fac_p['f_name']; ?>">
