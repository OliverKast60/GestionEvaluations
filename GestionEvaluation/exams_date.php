                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive mt-2">
                                                        ...
                                                        <table class="table table-striped nowrap" style="font-weight: normal;font: size 11px;background-color: white;" id="myTable">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $query = mysqli_query($con, "SELECT distinct tblevaluations.*,tblevaluations.id as a, tblsalles.*, tblcourses.* FROM `tblevaluations`, tblsalles,tblcourses where ((tblevaluations.date_eval like '" . $_GET['date'] . "') or (tblevaluations.e_salle like '" . $_GET['salle'] . "') or (tblevaluations.e_session like '" . $_GET['session'] . "') or (tblevaluations.e_type like '" . $_GET['type_ev'] . "')) and (tblevaluations.e_salle = tblsalles.id and tblevaluations.e_course=tblcourses.id) order by tblevaluations.date_eval desc");
                                                                    ...
                                                                    <form method="post" enctype="multipart/form-data">
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <select class="form-control" name="cours" required>
                                                                                <?php $query = mysqli_query($con, "SELECT * FROM `tblcourses`");
                                                                                $n = 1;
                                                                                while ($row = mysqli_fetch_array($query)) {
                                                                                ?>
                                                                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['c_intitule']; ?></option>
                                                                                <?php
                                                                                    $n++;
                                                                                }
                                                                                ?>
